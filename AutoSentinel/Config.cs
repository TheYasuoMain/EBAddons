...
namespace AutoSentinel
{
    public class Config
    {
        ...
        public static void Initialize()
        {
            ...
            //Initialize the menu
            Menu = MainMenu.AddMenu("AutoSentinel", "AutoSentinel");
            Menu.AddGroupLabel("Welcome to AutoSentinel!");
            Menu.AddGroupLabel("Thanks to Monstertje for script template!");
            Menu.AddGroupLabel("Thanks to Hellsing for basically all the code!");
